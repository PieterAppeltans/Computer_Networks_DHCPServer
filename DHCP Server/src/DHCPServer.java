...
public class DHCPServer {
	...
	public DHCPServer(String configurationAddress){
		try{
			...
			ErrorPrinter.print("Configuration File not found, using default set up");
			this.addressKeeper = new IPAddressKeeper(new byte[] {0,0,0,2}, new byte[] {0,0,0,(byte)255}, new byte[] {(byte)192,(byte)168,(byte)1,(byte)0}, 100, 1000, 10);
		}		
	}
