...
public class DHCPAck extends DHCPMessage {
	...
	public static Map<DHCPOption,byte[]> getDefaultOptions(byte[] leaseTime, byte[] serverIp, boolean acknowledged){
		...
		options.put(DHCPOption.IPADDRESSLEASETIME, leaseTime);
