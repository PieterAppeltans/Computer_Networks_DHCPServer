...
public class DHCPClient {
	...
	public void request(){
		...
		while (this.state == DHCPClientStates.REQUESTING){
			...
			DHCPMessage message = new DHCPRequest(this.xid,new byte[] { (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00 },this.getChaddr(),DHCPRequest.getDefaultOptions(this.offeredAddress,this.serverIdentifier,20));
			System.out.println("----------------------------------------------------------------------------");
